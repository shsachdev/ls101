...
The code ```[3,5]``` will end up being the return value of the each method on line 93 because that is the last code running within the block spanning the lines 93-97.
